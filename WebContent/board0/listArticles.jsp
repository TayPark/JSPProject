...
<br><br>
	<c:choose>
		<c:when test="${id != null }">
			...
			<a class = "cls1" href = "${contextPath}/user/logout.do"><p class = "cls2">로그아웃</p></a>
		</c:when>
		<c:when test="${id == null }">
			<a class = "cls1" href = "${contextPath}/user/login"><p class = "cls2">로그인</p></a>
			<a class = "cls1" href = "${contextPath}/user/register"><p class = "cls2">회원가입</p></a>				
		</c:when>
	</c:choose>
</body>
</html>
